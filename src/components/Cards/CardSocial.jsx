...
const CardSocial = ({ image, texto, icon }) => {
  return (
    <>
      ...
      <div className="flex flex-col w-60 h-64 lg:w-60 lg:h-64 md:w-48 md:h-52 sm:w-40 sm:h-44 max-sm:w-28 max-sm:h-28 shadow-2xl items-center rounded-2xl transition-all duration-700 hover:scale-110 cursor-pointer">
