...
import gobMex from '../../assets/gob_vinologo.svg'
...
const NavBarGob = () => {
  return (
    <>
    <div>
    <nav className="bg-gob-vino w-full top-0 shadow">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <img src={gobMex} alt="" className='h-16 w-36' />
          </div>
          <div className="hidden md:flex md:items-center items-center md:ml-6">
            <div className="ml-10 flex items-center space-x-4">
              ...
              <a href="https://www.gob.mx/tramites/" className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-xl font-medium">Tramites</a>
              <a href="https://www.gob.mx/gobierno" className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-xl font-medium">Gobierno</a>
