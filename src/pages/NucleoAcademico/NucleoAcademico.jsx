...
const datosPlantilla = [
  ...
  },
  {
    ...
    tiempo: "completo",
    semblanza:
      "Doctor con mención honorífica y Maestro en Ciencias de la Computación por el Tecnológico Nacional de México / Centro Nacional de Investigación y Desarrollo Tecnológico. Ingeniero en Tecnologías de la Información por la Universidad Politécnica de Victoria.\n\nRealizó una estancia de investigación en el proyecto ”Graficación de un modelo matemático para la estimación de glucosa en sangre para pacientes con diabetes” en la UPVictoria. Ha sido autor y coautor en diversas publicaciones en congresos internacionales, así como en revistas indexadas en el JCR. Adicionalmente ha ejercido como profesor en Universidad Tecmilenio campus Cuernavaca en el área de Tecnologías de la Información, en el Departamento de Tecnologías de la Información y Diseño de la Universidad Tecnológica de Emiliano Zapata. Actualmente ejerce como Profesor Investigador en el Instituto Tecnológico de Chilpancingo, en la Maestría en Ciencias de la Ingeniería.",
  },
  {
    image: MCValencia,
