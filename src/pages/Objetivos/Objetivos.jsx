    ...
    <>
        ...
        <div className='flex flex-row m-9 gap-10'>
            ...
            <div className='flex flex-col w-1/3 bg-white '>
                ...
                <div className='flex w-3/3 m-4 h-96 overflow-y-auto bg-white rounded-lg flex-col justify-center items-center border-4 border-blue-950'>
                  <div className='flex sticky top-0 z-20 mb-6 mt-6 bg-white w-full justify-center items-center '>
                    <h1 className=' text-4xl text-black font-sans font-semibold mb-20 mt-6'>Eventos</h1>
                  </div>                
